...
from config import (
    ...
    DEFAULT_PATIENCE, DEFAULT_SEED, DEFAULT_CLUSTERS,
    DEFAULT_BASE_CHANNELS, DEFAULT_COND_DIM, DEFAULT_NUM_BLOCKS,
)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a CNN for 3-D underwater acoustic field prediction")
    parser.add_argument("--epochs", type=int, default=DEFAULT_EPOCHS)
    parser.add_argument("--batch-size", type=int, default=DEFAULT_BATCH_SIZE)
    parser.add_argument("--clusters", type=int, default=DEFAULT_CLUSTERS)
    parser.add_argument("--seed", type=int, default=DEFAULT_SEED)
    parser.add_argument("--out-dir", type=str, default="./outputs_cnn_eofk")
...
def main():
    ...
    print("CNN training for 3-D underwater acoustic field prediction")
    ...
    # CNN configuration used for the experiment.
