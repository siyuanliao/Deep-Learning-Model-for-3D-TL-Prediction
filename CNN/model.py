"""Conditional CNN architecture for 3-D underwater acoustic field prediction."""
...
class SimpleConvBlock(nn.Module):
    """Basic convolution block with GroupNorm and ReLU activation."""
...
class SimpleConditionalCNN(nn.Module):
    """Conditional residual CNN for 3-D underwater acoustic field prediction."""
    def __init__(self, x1_dim=52, in_ch=4, base_ch=128, cond_dim=128, num_blocks=8):
        super().__init__()
